...
exports.run = (config, ready) ->
  ...
  # Configure the modules. Require the module using the namespaced
  # configuration from the server object. If namespaced configuration ins't
  # found, we'll just send the entire config object.
